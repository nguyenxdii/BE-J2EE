...
public class AdminUserController {
    ...
    public AdminUserController(UserRepository userRepository, EmailService emailService, NotificationService notificationService) {
    ...
    public ResponseEntity<AppApiResponse<User>> verifyIdentity(@PathVariable String id) {
        ...
        emailService.sendVerificationEmail(user.getEmail(), user.getFullName(), true, null);
    ...
    public ResponseEntity<AppApiResponse<User>> rejectIdentity(
        ...
        emailService.sendVerificationEmail(user.getEmail(), user.getFullName(), false, reason);
